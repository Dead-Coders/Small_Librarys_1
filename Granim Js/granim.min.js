...
})(
  {
      ...
      function (t, e, s) {
        ...
        function i(t) {
          (this.canvas = document.querySelector(t.element)),
            ...
            this.getDimensions(),
            this.isPausedWhenNotInView && this.pauseWhenNotInView(),
            this.setColors(),
            this.refreshColors(),
    ...
    8: [
      function (t, e, s) {
        "use strict";
        e.exports = function () {
          (this.x1 = this.canvas.width), (this.y1 = this.canvas.height);
        };
      },
      {},
    ],
          ...
          function t() {
            e && clearTimeout(e),
              (e = setTimeout(function () {
                var t = s.canvas.getBoundingClientRect(),
                  e =
                    t.bottom < 0 ||
                    t.right < 0 ||
                ...
                e
                  ? s.isPaused ||
                    ...
                    ((s.isPausedBecauseNotInView = !0), s.pause())
                  : s.isPausedBecauseNotInView &&
                    ((s.isPausedBecauseNotInView = !1), s.play());
              }, 300));
          }
          var e,
            s = this;
